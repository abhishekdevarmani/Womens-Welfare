...
ResultSet rs=s.stm.executeQuery("select * from feedback_details f,user_details u,wwa_details w where f.u_id=u.u_email and f.w_id=w.w_email and w.w_email='"+rz+"'");
while(rs.next())
{
