            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title">Select & Upload Photo <a class="btn btn-danger btn-sm" href="userdetails_view.jsp" onClick="return confirm('Are you sure?')">Cancel</a></h3>
...
<jsp:include page="val.jsp"></jsp:include>
 ...
 %>
<form id="WFS_Riz" name="form1" method="post" enctype="multipart/form-data" action="userdetails_upload_photo.jsp">
<div class="row">
