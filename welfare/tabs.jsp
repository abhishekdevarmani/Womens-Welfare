...
ResultSet rs1=s.stm.executeQuery("select sum(amount) from donation_details d,wwa_details w where w.w_email=d.w_id and w.w_email='"+rz+"'");
rs1.next();
int c2=rs1.getInt(1);
...
ResultSet rs3=s.stm.executeQuery("select count(f_id) from feedback_details where w_id='"+rz+"' and status='New'");
rs3.next();
int c4=rs3.getInt(1);
%>
<div class="content">
