...
<thead>
  <tr>
    ...
    <td width="71"><div align="center"><strong>Name Of User </strong></div></td>
    <td width="89"><div align="center"><strong>Association Name</strong> </strong></div></td>
    <td width="130"><div align="center"><strong>Complain Details</strong></div></td>
	<td width="112"><div align="center"><strong>Complain Date</strong></div></td>
	<td width="80"><div align="center"><strong>Evidence</strong></div></td>
	<td width="112"><div align="center"><strong>Complain Status</strong></div></td>
...
ResultSet rs=s.stm.executeQuery("select * from usercomplain_details ucd,user_details u,wwa_details w where ucd.u_id=u.u_email and ucd.w_id=w.w_email and w.w_email='"+rz+"'");
while(rs.next())
{
...
<tbody>
  <tr>
	...
	<td><div align="center"><a href="evidence_view.jsp?cid=<%=c_id%>" class="btn btn-warning">View Evidence</a></div></td>
	 <% if(sts.equals("requested")) { %>
	  <td width="147"><div align="center"><div style="background-color:blue; color:#FFFFFF; border-radius: 50px 50px; width:50%">Requested</div></div></td>
     <td width="147"><div align="center"><a onclick="return confirm('Are you sure?')" href="complaint_prms.jsp?cid=<%=c_id%>&pr=ac" class="btn btn-success btn-sm"><i class="ti-check"></i> Accept</a> <a onclick="return confirm('Are you sure?')" href="complaint_prms.jsp?cid=<%=c_id%>&pr=rj" class="btn btn-danger btn-sm"><i class="ti-close"></i> Reject</a></div></td> 
