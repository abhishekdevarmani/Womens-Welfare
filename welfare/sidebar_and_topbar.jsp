...
ResultSet rs=s.stm.executeQuery("select count(n_id) from notice_details");
rs.next();
int c1=rs.getInt(1);

ResultSet rs2=s.stm.executeQuery("select count(c_id) from usercomplain_details where w_id='"+rz+"' and c_status='requested'");
rs2.next();
int c2=rs2.getInt(1);
%>
<div class="wrapper">
            ...
            <ul class="nav">
				...
				<li>
                    <a href="notice_view.jsp">
                        ...
                        <p>Notice &nbsp;<font size="4" color="#FF6600">[ <%=c1%> ]</font></p>
                    </a>
                </li>
				...
				<li>
                    <a href="usercomplaindetails_view.jsp">
                        ...
                        <p>Complaints &nbsp;<font size="4" color="#0099FF">[ <%=c2%> ]</font></p>
                    </a>
                </li>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Welcome, <strong><%=rz%></strong></a>
                </div>
