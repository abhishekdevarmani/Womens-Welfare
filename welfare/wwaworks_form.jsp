...
<div class="row">
  ...
  <div class="col-md-11" style="padding-left: 26px; padding-right: 26px;">
   <div class="form-group">
       <label><strong>Welfare</strong></label>
   <input class="validate[required] form-control border-input" readonly="" value="<%=rz%>" name="wi" type="text" id="wi">
    </div>
	</div>
  ...
  <div class="col-md-11" style="padding-left: 26px; padding-right: 26px;">
   ...
   <input class="validate[required,custom[onlyLetter]] form-control border-input" name="tl" type="text" id="tl">
    </div>
	</div>
