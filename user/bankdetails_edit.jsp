...
<input name="bid" type="hidden" value="<%=a%>">
 <div class="row">
   ...
   <div class="form-group">
	   ...
	   <input class="validate[required,custom[onlyLetter]] form-control border-input" readonly="" value="<%=rs.getString("b_ac_holder")%>" name="ac" type="text" id="ac">
    </div>
	</div>
   ...
   <div class="form-group">
	   ...
	   <input class="validate[required,custom[onlyNumber]] form-control border-input" maxlength="16" value="<%=rs.getString("b_cardnumber")%>" name="cn" type="text" id="cn">
    </div>
	</div>
   ...
   <div class="form-group">
	   ...
	   <input class="validate[required,custom[onlyNumber]] form-control border-input" maxlength="4 " value="<%=rs.getString("b_spin")%>" name="sp" type="text" id="sp">
    </div>
	</div>
   ...
   <div class="form-group">
	   ...
	   <input class="validate[required,custom[onlyLetter]] form-control border-input" readonly="" value="<%=rs.getString("b_status")%>" name="st" type="text" id="st">
    </div>
 </div>
