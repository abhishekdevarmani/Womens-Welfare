            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title">Select & Upload Photo <a class="btn btn-danger btn-sm" href="wwaworks_view.jsp" onClick="return confirm('Are you sure?')">Cancel</a></h3>
...
<form id="WFS_Riz" name="form1" method="post" enctype="multipart/form-data" action="wwaworks_upload_photo.jsp">
<div class="row">
