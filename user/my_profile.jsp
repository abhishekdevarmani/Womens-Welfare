...
rs.next();
%>
<div style="margin-left:20px"><img src="../uploads/<%=rs.getString("u_photo")%>" width="120px" height="120px"/></div>
<div style="margin-left:30px"><a href="userdetails_select_photo.jsp">Change Picture</a></div>
</br>
<form id="WFS_Riz" name="form1" method="post" action="userdetails_update.jsp">
<input name="uid" type="hidden" value="<%=rs.getInt("u_id")%>">
<div class="row">
   ...
   <div class="form-group">
    ...
    <input class="validate[required,custom[mobile]] form-control border-input" value="<%=rs.getString("u_mobile")%>" maxlength="10" name="mbl" type="text" id="mbl">
    </div>
	</div>
  ...
  <div class="col-md-11" style="padding-left: 26px; padding-right: 26px;">
   <div class="form-group">
      ...
      <input  class="validate[required,custom[email]] form-control border-input" value="<%=rs.getString("u_email")%>" readonly="" name="em" type="text" id="em">
    </div>
	</div>
