            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title">User Complaints</h3>
...
<form id="WFS_Riz" name="form1" method="post" action="usercomplaindetails_insert.jsp">
<div class="row">
   ...
   <div class="form-group">
       ...
       <textarea name="cdl" class="validate[required] form-control border-input" id="cdl"></textarea>
    </div>
	</div>
	<%
	Date d=new Date();
   ...
   <div class="form-group">
      ...
      <input class="form-control border-input" name="da" value="<%=td%>" readonly="" type="text" id="cd" >
    </div>
	</div>
   ...
   <div class="form-group">
      ...
      <input class="validate[required,custom[onlyLetter]] form-control border-input" value="requested" readonly="" name="cs" type="text" id="cs">
    </div>
	</div>
