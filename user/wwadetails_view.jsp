            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title"> Women's Welfare <!--<a class="btn btn-success btn-sm" href="wwadetails_form.jsp"><i class="ti-plus"></i> Add New</a> --></h3>
                            </div>
...
<tbody>
    <tr>
      ...
      <td><div align="center"><a class="btn btn-success" href="wwaworks_view.jsp?eml=<%=eml%>">View Work Done</a></div></td>
  </tr>
<%
}
%>
