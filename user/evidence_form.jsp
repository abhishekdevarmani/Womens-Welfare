...
<div class="row">
   ...
   <div class="form-group">
	  ...
	  <select readonly class="validate[required] form-control border-input" name="ci" id="ci">
	  <!--<option value="">-- Select Complaint--</option> -->
	  <%
	  String cid=request.getParameter("cid");
	  ResultSet rs=s.stm.executeQuery("select * from usercomplain_details where c_id='"+cid+"'");
	  while(rs.next())
	  {
	  %>
   ...
   <div class="form-group">
	...
	<button type="Submit" name="Submit" class="btn btn-success btn-fill btn-wd"> Confirm & Submit</button>
