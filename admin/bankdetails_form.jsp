...
<div class="row">
 ...
 <div class="col-md-11" style="padding-left: 26px; padding-right: 26px;">
  ...
  <input class="validate[required,custom[onlyNumber] form-control border-input" name="am" type="text" id="am"></td>
     </div>
   </div>
   ...
   <div class="form-group">
	...
	<input class="validate[required,custom[onlyLetter]] form-control border-input" name="st" type="text" id="st">
     </div>
   </div>
