...
<div class="row">
   ...
   <div class="form-group">
      ...
      <input class="validate[required,custom[onlyLetter]] form-control border-input" name="cdl" type="text" id="cdl">
    </div>
	</div>
	<%
	Date d=new Date();
   ...
   <div class="form-group">
      ...
      <input class="validate[required,custom[onlyLetter]] form-control border-input" name="cs" type="text" id="cs">
    </div>
	</div>
