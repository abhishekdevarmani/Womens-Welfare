            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title">Feedback Details <!--<a class="btn btn-success btn-sm" href="feedback_form.jsp"><i class="ti-plus"></i> Add New</a> --></h3>
                            </div>
                            <div class="content table-responsive table-full-width">
<table class="table table-striped">
<thead>
  <tr>
    <th width="120"><div align="center"><strong>Sl.</strong></div></th>
    <th width="73"><div align="center"><strong>From</strong></div></th>
...
<%
int sl=0;
ResultSet rs=s.stm.executeQuery("select * from feedback_details f,user_details u,wwa_details w where f.u_id=u.u_email and f.w_id=w.w_email");
while(rs.next())
{
