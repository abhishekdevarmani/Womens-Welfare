...
<thead>
  <tr>
    ...
    <td width="114"><div align="center"><strong>Complain Details</strong></div></td>
...
<%
int sl=0;
ResultSet rs=s.stm.executeQuery("select * from usercomplain_details ucd,user_details u,wwa_details w where ucd.u_id=u.u_email and ucd.w_id=w.w_email");
while(rs.next())
{
