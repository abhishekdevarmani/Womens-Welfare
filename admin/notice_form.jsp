...
<div class="row">
  ...
  <div class="col-md-11" style="padding-left: 26px; padding-right: 26px;">
   <div class="form-group">
    ...
    <input class ="validate[required] form-control border-input" value="Admin" readonly="" name="nf" type="text" id="nf">
     </div>
   </div>
   ...
   <div class="form-group">
       ...
       <textarea name="nn" class="validate[required,custom[onlyLetter]] form-control border-input" id="nn"></textarea>
    </div>
	</div>
	<%
	Date d=new Date();
